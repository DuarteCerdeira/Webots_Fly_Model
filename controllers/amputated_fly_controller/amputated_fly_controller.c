...
const double rear_lower_limits[N_LEG_JOINTS] = {-1.0, -0.6, -0.2, 0.6, -2.2, 0.2};
...
int main(int argc, char **argv) {
  ...
  fprintf(results_output, "|===Checker Plots===|        LF         |        LR         |        RF         |        RR         |\n");
  fprintf(results_output, "| LF | LR | RF | RR |    t    |    l    |    t    |    l    |    t    |    l    |    t    |    l    |\n");
